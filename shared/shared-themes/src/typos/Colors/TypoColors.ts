...
import { TypoDark as dark, TypoLight as light, IThemeTypoColors } from './Themes';
...
export const themeTypoColors: TthemeTypoColors = (theme: TThemeKeys) => TypoColors[theme];
